...
void Graph::createGameGraphNew()
{
    // ZONA MORADA(EN EL CROQUIS)
        ...
        nodes[8]  = Node(8, new vec3[3]{i_0, j_0, f_0} , set<int>{9,11} );
    ...
    // ZONA VERDE(EN EL CROQUIS)
        ...
        nodes[27] = Node(27, new vec3[3]{k_0, x_0, a_1} );
        ...
        nodes[31] = Node(31, new vec3[3]{g_1,b_1,p_1} , set<int>{32,38} );
        ...
        nodes[40] = Node(40, new vec3[3]{c_1,o_1,j_1} , false );

        nodes[41] = Node(41, new vec3[3]{g_1,t_1,o_1} );
        nodes[42] = Node(42, new vec3[3]{o_1,w_1,t_1} , set<int>{44} );
        nodes[43] = Node(43, new vec3[3]{p_1,t_1,u_1} , set<int>{46} );
        nodes[44] = Node(44, new vec3[3]{t_1,w_1,z_1} );
    ...
    // ZONA ROSA(EN EL CROQUIS)
        ...
        nodes[53] = Node(53, new vec3[3]{c_2,h_2,d_2} );
        ...
        nodes[60] = Node(60, new vec3[3]{j_2,w_2,o_2} , set<int>{61,64} );
        ...
        nodes[71] = Node(71, new vec3[3]{g_2,p_2,f_2} , set<int>{75} );
    ...
    // ZONA AZUL(EN EL CROQUIS)
        ...
        nodes[78]  = Node(78, new vec3[3]{n_3,o_3,u_3} );
        ...
        nodes[95]  = Node(95, new vec3[3]{f_3,k_3,h_3} );
    ...
    // ZONA ROJO(EN EL CROQUIS)
        ...
        nodes[101]  = Node(101, new vec3[3]{e_3,f_3,z_4} );
        nodes[102]  = Node(102, new vec3[3]{z_4,f_3,v_4} );
        nodes[103]  = Node(103, new vec3[3]{y_4,z_4,v_4} );
        nodes[104]  = Node(104, new vec3[3]{u_4,v_4,y_4} );
        nodes[105]  = Node(105, new vec3[3]{u_4,t_4,y_4} );
        nodes[106]  = Node(106, new vec3[3]{p_4,u_4,t_4} );
        ...
        nodes[124]  = Node(124, new vec3[3]{n_4,h_4,a_0} );
